...
* focus with UGUI ([305af5a](https://github.com/BlenMiner/NowUI/commit/305af5a5533c0b524329c196d25def1b0a725d38))
...
* allow auto layouting for world graphics too ([55fb57d](https://github.com/BlenMiner/NowUI/commit/55fb57dd71e90894529bf27e7d81fad179dc3bb7))
* clicks no longer pass through occluding UGUI ([03cf213](https://github.com/BlenMiner/NowUI/commit/03cf213c9f4b7500a7b7bc2f2262689b0ac6a479))
* code editor corner rendering + add scrollbars ([784ada5](https://github.com/BlenMiner/NowUI/commit/784ada5ac979c20e573ab69f49cf19aee8279486))
* context menus are modal — block beneath, scroll dismisses ([4e70cf5](https://github.com/BlenMiner/NowUI/commit/4e70cf5c425f5d3b4894ffa9c9f50face99a4cb2))
* disable harfbuzz default features for WebGL lane ([9c7fe06](https://github.com/BlenMiner/NowUI/commit/9c7fe060b8d8111face538816d2f49ac865260aa))
* duplicate-label id collisions + Begin() content clipping/convergence ([e38d725](https://github.com/BlenMiner/NowUI/commit/e38d725830c50f41096fab1ca423899de2e1c83f))
* embed HarfBuzz via amalgamated build instead of vcpkg ([fc87bdd](https://github.com/BlenMiner/NowUI/commit/fc87bdda6f772350b875adda5dc02e2175456f6b))
* focus issues with navigation ([9b4bbac](https://github.com/BlenMiner/NowUI/commit/9b4bbace5b8193af55a3ab88cf85d610b7f0a18b))
* improve performance ([6ea5adb](https://github.com/BlenMiner/NowUI/commit/6ea5adb2931e668579ed07285b809c125e0a33c9))
* improve projection matrix width and height checks ([4ec0b54](https://github.com/BlenMiner/NowUI/commit/4ec0b541a3eff2565f7a3e64ac8e47a71fc63070))
* measure-pass id collisions + docs browser readability ([28d4911](https://github.com/BlenMiner/NowUI/commit/28d4911f5478612a55053544266760312d1c0354))
* mobile feature, worflow packing and optimisations ([fdbadaa](https://github.com/BlenMiner/NowUI/commit/fdbadaa44c64f902ed4b817e348b5541d77fb067))
* null reference in ToProjectFullPath method ([b0bc502](https://github.com/BlenMiner/NowUI/commit/b0bc5021664baaeda9e17ef0ec5948a9b198dd7d))
* remove visibility for internal methods to avoid confusion ([0420117](https://github.com/BlenMiner/NowUI/commit/0420117e004a8b29b0888743f524c458d44c25e9))
* replace mapfile with bash 3.2 compatible read loop in iOS packaging ([f67a00b](https://github.com/BlenMiner/NowUI/commit/f67a00b06dbc6756870ed99bd19f6767e0559e30))
* split lottie into multiple submeshes if it demands for it ([7397d44](https://github.com/BlenMiner/NowUI/commit/7397d4432461aa87a2fcc9b4b9dbaa6e25cda67e))
* text-erasing mask defaults, missing bold fallback, outline rendering ([3593df1](https://github.com/BlenMiner/NowUI/commit/3593df17275b5a36fb076a6d8ea13955e4b841cc))
* Tools/NowUI ([1574bf9](https://github.com/BlenMiner/NowUI/commit/1574bf951739a10b19e076736404d3a2bc4277d1))


### Features

* add cross-axis alignment for group children with SetAlignItems ([75fa0ee](https://github.com/BlenMiner/NowUI/commit/75fa0ee513ede1395b94bf27f2aad6359f268733))
* add line shortcuts and key repeat functionality in code editor ([93d3eb6](https://github.com/BlenMiner/NowUI/commit/93d3eb63466147691d4f383f5e14374aec5ec18f))
* add RenderTexture example and documentation for NowUI ([7381987](https://github.com/BlenMiner/NowUI/commit/7381987a8b6943d2363864e5c6130f4aea0f0723))
* AI helper ([43c53cd](https://github.com/BlenMiner/NowUI/commit/43c53cd5fa2e095a54957da9b9eb4e67bd00a6eb))
* Begin() content scopes on Checkbox and Radio, unified scope type ([8755f2d](https://github.com/BlenMiner/NowUI/commit/8755f2d0b76576b4bfac5ad21a19ebe6d1815260))
* browser-style text selection (core) + selectable markdown code blocks ([ab6f26c](https://github.com/BlenMiner/NowUI/commit/ab6f26c71f5bb218c22bafb7e0cf9d676a90e4a7))
* bundled Roslyn analyzer for provable builder/scope misuse ([a9541a3](https://github.com/BlenMiner/NowUI/commit/a9541a3b4977a5c7c71f5daad9780a03c627f16c))
* Burst-compiled managed Lottie tessellator ([cd30836](https://github.com/BlenMiner/NowUI/commit/cd3083671537f5e9ce29b748bbbb6b4955b46a2e))
* code editor extension (JSON + markdown profiles) ([cfa2ff8](https://github.com/BlenMiner/NowUI/commit/cfa2ff8777babb81e14a6ef65e1d720af65521a7))
* context menus (core) + selectable markdown paragraphs ([c9062cc](https://github.com/BlenMiner/NowUI/commit/c9062ccde3d429e58a7a157bdf0fd55e85830141))
* control interaction fixes, UGUI LayoutGroup sizing, comment cleanup ([8c35c1b](https://github.com/BlenMiner/NowUI/commit/8c35c1b1265fc90dff1ef7b2e9a6ad116b469063))
* controls foundation + Button, Checkbox, Radio, Slider ([7a09659](https://github.com/BlenMiner/NowUI/commit/7a096590993a6b7a70bdc50babbec71691fca182))
* controls phases 2-3 - ScrollView, TextField, Dropdown, overlays ([f7b80c8](https://github.com/BlenMiner/NowUI/commit/f7b80c87189020d07844cd1ba98fe4e81e82021e))
* docs browser Lottie demo page + stable sidebar sizing ([5543c22](https://github.com/BlenMiner/NowUI/commit/5543c22f5b8d6dc2424007a5ec6cf40e8b3e04ce))
* document-wide selection + fix stale overlay block after menu close ([1064fb7](https://github.com/BlenMiner/NowUI/commit/1064fb79f18632b56ddbbd5dd85da31e0094bf61))
* EventSystem focus interop + typed theme tokens ([e2ec111](https://github.com/BlenMiner/NowUI/commit/e2ec1115f001454ccc2728c3253271f594eadd6b))
* GitHub-flavored Markdown extension (NowUI.Extensions.Markdown) ([338ab18](https://github.com/BlenMiner/NowUI/commit/338ab18154273d82d93212cf241e43a362928606))
* gradients ([4dd32ab](https://github.com/BlenMiner/NowUI/commit/4dd32abf773e4d3060d6d7cd77bc24adaa9de22a))
* HarfBuzz shaping API in nowui-msdf native plugin ([64a292c](https://github.com/BlenMiner/NowUI/commit/64a292c1873a9cd760350f91dc6c87baf8472a75))
* HarfBuzz text shaping pipeline ([e9275e6](https://github.com/BlenMiner/NowUI/commit/e9275e6db4a7fa7343c5f17cd0f0e3b1eb4a0017))
* IME composition + triple-click line selection ([5beead8](https://github.com/BlenMiner/NowUI/commit/5beead89f7e277dfee3adb99d23a0cecdda37f25))
* implement automatic control identity using caller info for unique control instances ([77103e9](https://github.com/BlenMiner/NowUI/commit/77103e925ae3633806b61fbd07ad887c1a1b517b))
* introduce font stack ([8cf7345](https://github.com/BlenMiner/NowUI/commit/8cf7345112fd77491ece81f64f7b0e206a8b1e62))
* layout + text measurements fixes ([de0775f](https://github.com/BlenMiner/NowUI/commit/de0775f5a408c4982696d5d49805ec4580caa5d0))
* Lottie integration with native renderer (CPU) ([1dd6950](https://github.com/BlenMiner/NowUI/commit/1dd69504a53a251fd7aa8462cec379b11e87c1b3))
* managed font compiler fallback with Burst SDF baking ([fd30e6e](https://github.com/BlenMiner/NowUI/commit/fd30e6e7612696310332660ea6e613490d2b297e))
* managed-first font compiler + shaping bindings and by-index baking ([fe8b6e1](https://github.com/BlenMiner/NowUI/commit/fe8b6e144800ca0b8ea0485cf80e37863747e9fa))
* markdown copy button, clickable/local images, unified link spans ([b71e174](https://github.com/BlenMiner/NowUI/commit/b71e17483271fa4da17b6749bf18410f4ff73962))
* markdown syntax highlighting, images, and textured rectangles ([0bb9d49](https://github.com/BlenMiner/NowUI/commit/0bb9d495fd56a9110a29b7816336efe1b62020a0))
* multi-line text editing (NowTextArea) ([11ed1f1](https://github.com/BlenMiner/NowUI/commit/11ed1f17372e346760c1274d013559f89f63435a))
* NowLayout.Lottie ([b124524](https://github.com/BlenMiner/NowUI/commit/b124524849707ba9129f54fb48544d3ec0690262))
* shapes + refactoring ([ebcf1dc](https://github.com/BlenMiner/NowUI/commit/ebcf1dc7f4f5bc33282b18c21643c9283d6eb61f))
* side-by-side native vs managed font compiler example ([6ba76c1](https://github.com/BlenMiner/NowUI/commit/6ba76c153f71abc3cae807718b2469debe061092))
* sprite/9-slice rendering and extension-author DX round ([12f5f41](https://github.com/BlenMiner/NowUI/commit/12f5f411fcddd87404db03db8b02823accf7eacb))
* UGUI elements occlude NowUI pointer input ([298e63c](https://github.com/BlenMiner/NowUI/commit/298e63c9f5e39b9a795c2afca7024b6a506bbeb0))
* UIToolkit support and reduce native binary size ([a7a5f69](https://github.com/BlenMiner/NowUI/commit/a7a5f69d652dfedebb65133f7a02de5b14ac7e87))
* versioning ([600446e](https://github.com/BlenMiner/NowUI/commit/600446ecabe8f893a326459cc13bf95f6f3b7789))
* view stack ; fixes ([bc45a83](https://github.com/BlenMiner/NowUI/commit/bc45a83ad85a17cd02e6ecc424ca552931717062))
* world graphics ([aa51e84](https://github.com/BlenMiner/NowUI/commit/aa51e84d129aa482e2d5d4d63481642a8842534e))
