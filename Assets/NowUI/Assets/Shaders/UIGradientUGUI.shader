    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float dist = sdRoundedBox(position, i.rect.zw * 0.5, radius);
