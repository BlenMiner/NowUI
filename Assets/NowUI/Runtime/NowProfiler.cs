...
{
    /// <summary>
    /// Profiler markers for NowUI's subsystems, visible as "NowUI.*" in the
    ...
    public static class NowProfiler
    {
        ...
        public static readonly ProfilerMarker MeasurePass = new ProfilerMarker("NowUI.Layout.MeasurePass");

        /// <summary>The user's DrawNowUI / immediate-mode draw calls.</summary>
        public static readonly ProfilerMarker Draw = new ProfilerMarker("NowUI.Draw");

        /// <summary>Building and uploading the canvas meshes after a rebuild.</summary>
        public static readonly ProfilerMarker MeshUpload = new ProfilerMarker("NowUI.MeshUpload");

        /// <summary>Assigning meshes/materials to the CanvasRenderers.</summary>
        public static readonly ProfilerMarker ApplyCanvasPages = new ProfilerMarker("NowUI.Graphic.ApplyCanvasPages");

        /// <summary>One DrawString call: shaping lookup, glyph resolution, quad emission.</summary>
        public static readonly ProfilerMarker TextDraw = new ProfilerMarker("NowUI.Text.Draw");

        /// <summary>A HarfBuzz shaping call (cache misses only; shaped runs are cached).</summary>
        public static readonly ProfilerMarker TextShape = new ProfilerMarker("NowUI.Text.Shape");

        /// <summary>Baking missing glyphs into a dynamic atlas page (spiky, first-use cost).</summary>
        public static readonly ProfilerMarker FontBake = new ProfilerMarker("NowUI.Font.Bake");

        /// <summary>Tessellating a Lottie frame (cache misses only; frames are cached).</summary>
        public static readonly ProfilerMarker LottieRender = new ProfilerMarker("NowUI.Lottie.Render");

        /// <summary>Deferred overlay draws (dropdown popups, tooltips).</summary>
        public static readonly ProfilerMarker OverlayFlush = new ProfilerMarker("NowUI.Overlay.Flush");

        /// <summary>The screen path's end-of-frame GL submission.</summary>
        public static readonly ProfilerMarker FlushUI = new ProfilerMarker("NowUI.FlushUI");
    }
}
